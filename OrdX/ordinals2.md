...
最初，Ordinals协议就像IP/UDP协议，只能发行一个NFT；后来，Ordinals X协议增强了它，让它像IP/TCP协议一样，可以发很多FT。而这两者特有的混合模式，也就是SFT，是它的原生方式，图币二相性只是SFT的一种形式。至此，Ordinals协议，真正有了构建BTC生态的能力，有了比肩IP协议的底气。Ordinals Summer，必将到来。
